...
<Toc
	links={[
		{ degree: 1, order: 1, name: 'Installation' },
		{ degree: 2, order: 3, name: 'what is split' },
		{ degree: 1, order: 2, name: 'type safety' },
		{ degree: 2, order: 4, name: 'blazingly fast websites' }
	]}
/>
